...
SELECT date_bin(INTERVAL '5 minutes', to_timestamp_nanos(CAST("StartTimeUnixNano" AS BIGINT)), TIMESTAMP '1970-01-01 00:00:00') as time_bucket, COUNT(*) as rate FROM base_spans
