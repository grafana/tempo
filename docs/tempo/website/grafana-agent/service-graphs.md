...
The same service graph metrics can also be generated by Tempo. This is more efficient and recommended for larger installations. For additional information about viewing service graph metrics in Grafana and calculating cardinality check out the [server side documentation](../../server_side_metrics/service_graphs#grafana).
