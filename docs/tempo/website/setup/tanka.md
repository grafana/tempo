...
[Metrics generation](https://grafana.com/docs/tempo/next/configuration/#metrics-generator) is enabled in the above configuration, but where to send the generated metrics data hasn't been specified yet.
