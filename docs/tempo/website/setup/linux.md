...
These instructions focus on a single binary install. You can also run it in distributed mode by deploying multiple binaries and using a distributed configuration.
