...
- The metrics-generator now handles collisions between user-defined and default dimensions [PR 1794](https://github.com/grafana/tempo/pull/1794). User-defined dimensions colliding with default dimensions will be prefixed with `__`.
...
If you're migrating to the Parquet storage format, consider updating your configuration to use these default values. 
...
| search_enabled | Removed and set to true |
| metrics_generator_enabled | Removed and set to true |
