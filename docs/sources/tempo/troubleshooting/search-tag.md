...
* Increase the `max_bytes_per_tag_values_query` parameter in the [overrides](../../configuration/#overrides) block of your Tempo configuration to a value as high as 50MB.
