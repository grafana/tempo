...
Grafana's service graph view utilizes metrics generated by the metrics-generator to display span request rates, error rates, and durations, as well as service graphs.
