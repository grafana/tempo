...
* [Services graphs](../service_graphs/enable-service-graphs/), which are enabled by default in Grafana
* [Span metrics](../span_metrics/#how-to-run) enabled in your Tempo data source configuration
