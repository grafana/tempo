...
Refer to [Tempo in Grafana](https://grafana.com/docs/tempo/<TEMPO_VERSION>/visualize-traces/) for an overview about how tracing data can be viewed and queried in Grafana.
