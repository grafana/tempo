...
{{< admonition type="tip" >}}
If you want to explore tracing data in Grafana, try the [Intro to Metrics, Logs, Traces, and Profiling example](../../docker-example/).
{{< /admonition >}}
...
Refer to [Tempo in Grafana](https://grafana.com/docs/tempo/<TEMPO_VERSION>/introduction/tempo-in-grafana) for an overview about how tracing data can be viewed and queried in Grafana.
