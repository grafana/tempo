...
For a deep look into service graphs, visit [this section](../../../metrics-from-traces/metrics-generator/service_graphs/).

Service graphs are also used in the application performance management dashboard.
For more information, refer to the [service graph view documentation](../../../metrics-from-traces/metrics-generator/service-graph-view/).
...
For additional information about viewing service graph metrics in Grafana and calculating cardinality, refer to the [server side documentation](../../../metrics-from-traces/metrics-generator/service_graphs/enable-service-graphs/).
