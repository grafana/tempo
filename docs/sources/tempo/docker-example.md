...
If you want to use Tempo in production, refer to the [Set up for tracing](/docs/tempo/<TEMPO_VERSION>/set-up-for-tracing/) documentation.
...
- Set up Tempo by following the [Set up for tracing documentation](/docs/tempo/<TEMPO_VERSION>/set-up-for-tracing/setup-tempo/).
- Learn how to [instrument your application](/docs/tempo/<TEMPO_VERSION>/set-up-for-tracing/instrument-send/set-up-instrumentation/) to emit traces.
...
- [Instrumenting your application](https://grafana.com/docs/tempo/<TEMPO_VERSION>/set-up-for-tracing/instrument-send/)
- [Set up for tracing](https://grafana.com/docs/tempo/<TEMPO_VERSION>/set-up-for-tracing/)
