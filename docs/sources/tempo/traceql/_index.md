...
For more information, refer to [TraceQL query editor]({{< relref "./query-editor" >}}).
...
For more information on planned future work, refer to [How TraceQL works]({{< relref "./architecture" >}}).
