...
For Tempo settings, refer to [Use the metrics-generator to create metrics from spans](/docs/tempo/<TEMPO_VERSION>/metrics-from-traces/span-metrics/span-metrics-metrics-generator/).
