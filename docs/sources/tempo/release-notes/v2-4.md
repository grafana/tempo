...
In addition, you can use Grafana Explore to [query and visualize the metrics](../../operations/traceql-metrics/) with the Tempo data soruce in Grafana or Grafana Cloud.
...
To learn more about the TraceQL syntax, see the [TraceQL documentation](../../traceql/). For information on planned future extensions to the TraceQL language, refer to [future work](../../traceql/architecture/).
...
For information on upgrading, refer to [Upgrade to Tempo 2.4](../../setup/upgrade/) and [Choose a different block format](../../configuration/parquet/#choose-a-different-block-format) .
