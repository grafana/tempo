...
When [upgrading](https://grafana.com/docs/tempo/<TEMPO_VERSION>/set-up-for-traces/setup/upgrade/) to Tempo 2.6, be aware of these considerations and breaking changes.
