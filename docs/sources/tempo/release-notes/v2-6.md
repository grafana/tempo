...
* New TraceQL features, including events, links, and arrays
* vParquet4 block format is the default block format
* New operational patterns shift TraceQL Metrics from replication factor (RF) 3 blocks to RF1 blocks
...
* Exemplars [PR [PR 3824](https://github.com/grafana/tempo/pull/3824), [documentation](https://grafana.com/docs/tempo/next/traceql/metrics-queries/#exemplars)]
* Instant metrics queries using `/api/metrics/query` [PR [PR 3859](https://github.com/grafana/tempo/pull/3859), [documentation](https://grafana.com/docs/tempo/next/api_docs/#traceql-metrics)]
* A `q` parameter to tag-name filtering the search v2 API [PR [PR 3822](https://github.com/grafana/tempo/pull/3822), [documentation](https://grafana.com/docs/tempo/next/api_docs/#traceql-metrics)]
...
Additionally, we are working on refactoring the replication factor. Refer to the Operational change for TraceQL metrics section for details.
...
### Operational shift from RF3 to RF1

With the release of Tempo 2.6, we’re shifting to a replication factor 1 (RF1) pattern for TraceQL metrics.

Refer to the [Operation change to TraceQL metrics](operational-change-for-traceql-metrics) for details.


### vParquet4 promoted to stable

[vParquet](https://grafana.com/docs/tempo/latest/configuration/parquet/)4, an updated Parquet block format introduced in Tempo 2.5, has been promoted to stable and is production ready. [PR [PR 3810](https://github.com/grafana/tempo/pull/3810)]
...
You can also use the `tempo-cli analyse blocks` command to query vParquet4 blocks. [PR [PR 3868](https://github.com/grafana/tempo/pull/3868)].
...
To use vParquet4, refer to [Choose a block format](https://grafana.com/docs/tempo/latest/configuration/parquet/#choose-a-different-block-format).
...
The `event` scope lets you query events that happen within a span. A span event is a unique point in time during the span’s duration. While spans help build the structural hierarchy of your services, span events can provide a deeper level of granularity to help debug your application faster and maintain optimal performance. To learn more about how you can use span events, read the [What are span events?](https://grafana.com/blog/2024/08/15/all-about-span-events-what-they-are-and-how-to-query-them/) blog post. [PRs [PR 3708](https://github.com/grafana/tempo/pull/3708), [3708](https://github.com/grafana/tempo/pull/3748), [3908](https://github.com/grafana/tempo/pull/3908)]
...
We’ve also added autocomplete support for `events` and `links`. [PR [PR 3846](https://github.com/grafana/tempo/pull/3846)]
...
One of our major improvements in Tempo 2.6 is the reduction of memory usage due to polling improvements.
...
* BlockMeta improvements to reduce the size [PR 3950](https://github.com/grafana/tempo/pull/3950) [PR 3951](https://github.com/grafana/tempo/pull/3951) [PR 3952](https://github.com/grafana/tempo/pull/3952)
