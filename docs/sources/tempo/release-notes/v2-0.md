...
For information on how we plan to extend the TraceQL language, see [future work](../../traceql/architecture/).
...
When [upgrading](../../setup/upgrade/) to Tempo 2.0, be aware of these breaking changes.
