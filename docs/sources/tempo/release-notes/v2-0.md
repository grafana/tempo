...
Search and [metrics-generator](../../metrics-from-traces/metrics-generator/) are now enabled by default in Tempo 2.0, and their corresponding configuration parameters (`search_enabled` and `metrics_generator_enabled`) have been removed.
