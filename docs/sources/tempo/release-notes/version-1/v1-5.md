...
weight: 100
aliases:
  - ../v1-5/ # /docs/tempo/<TEMPO_VERSION>/release-notes/v1-5/
---
...
such as the [service graph view](../../../metrics-from-traces/service_graphs/service-graph-view/) which visualizes span metrics (traces data for rates, error rates, and durations (RED)) and service graphs.
...
The [metrics-generator](../../../metrics-from-traces/metrics-generator/) now includes databases and requests across messaging systems in service graph metrics.
