...
weight: 200
aliases:
  - ../v1-4/ # /docs/tempo/<TEMPO_VERSION>/release-notes/v1-4/
---
...
- **Server-side metrics** As the headline feature for Tempo 1.4, [Server-side metrics](../../../metrics-from-traces/metrics-generator/)
