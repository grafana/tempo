...
For more information, refer to [Retrieve most recent results (experimental)](https://grafana.com/docs/tempo/<TEMPO_VERSION>/traceql/#retrieving-most-recent-results-experimental).
...
Refer to the [documentation](https://grafana.com/docs/tempo/<TEMPO_VERSION>/traceql/#intrinsic-fields) for more information.
