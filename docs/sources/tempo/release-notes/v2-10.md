...
You can identify gaps in your instrumentation by finding spans where epxected attributes are absent.
...
Analyze trace structure by finding spans based on how many child operations they spawn. [[PR 6126](https://github.com/grafana/tempo/pull/6126), [documentation](/docs/tempo/<TEMPO_VERSION>/traceql/construct-traceql-queries/#find-spans-by-child-count)]

This helps you:

- Identify terminal operations such as database calls or external API requests
- Detect high fan-out patterns that may indicate N+1 query problems or excessive parallelism
