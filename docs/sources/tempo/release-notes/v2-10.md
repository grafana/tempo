...
While the new architecture is available in Tempo, its still considered experimental.
...
- Fixed query_end_cutoff param for query range. [[PR 6360](https://github.com/grafana/tempo/pull/6360)]
