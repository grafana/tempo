...
This experimental feature adds an MCP server in the query frontend, allowing seamless integration with AI systems for trace analysis and debugging. ([PR 5212](https://github.com/grafana/tempo/pull/5212))
...
We've implemented multiple optimizations to improve TraceQL query performance:
