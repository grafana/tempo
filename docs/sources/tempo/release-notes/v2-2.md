...
* JSonnet users only: Convert metrics generator from deployment to a statefulset in JSonnet. Refer to the PR for seamless migration instructions. [PRs [#2533](https://github.com/grafana/tempo/pull/2533), [#2467](https://github.com/grafana/tempo/pull/2647)]
