...
- The metrics-generator can now detect virtual nodes ([documentation](https://grafana.com/docs/tempo/<TEMPO_VERSION>/metrics-from-traces/service_graphs/#virtual-nodes)) [PR [2365](https://github.com/grafana/tempo/pull/2365)]. As a result, you'll now see these virtual nodes represented in your service graph. For more information, refer to the [virtual nodes documentation](https://grafana.com/docs/tempo/<TEMPO_VERSION>/smetrics-from-traces/service_graphs/#virtual-nodes).
