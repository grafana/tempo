...
*  Fix node role auth IDMSv1 [PR 2760](https://github.com/grafana/tempo/pull/2760)
...
*  Restore `tenant_header_key` removed in [PR 2414](https://github.com/grafana/tempo/pull/2414) [PR 2786](https://github.com/grafana/tempo/pull/2795)
* [BUGFIX] Disable streaming over HTTP by default [PR 2803](https://github.com/grafana/tempo/pull/2803)
