...
- Updated `go.opentelemetry.io/otel/sdk` to v1.43.0 to address [CVE-2026-39883](https://github.com/advisories/GHSA-hfvc-g4fc-pqhx). [[PR 6904](https://github.com/grafana/tempo/pull/6904)]
- Updated OTLP HTTP exporter modules (`otlptracehttp`, `otlpmetrichttp`, `otlploghttp`) to address [CVE-2026-39882](https://github.com/advisories/GHSA-w8rr-5gcm-pp58). [[PR 6891](https://github.com/grafana/tempo/pull/6891), [PR 6892](https://github.com/grafana/tempo/pull/6892), [PR 6893](https://github.com/grafana/tempo/pull/6893)]
- Updated `google.golang.org/grpc` to v1.79.3 to address [CVE-2026-33186](https://github.com/advisories/GHSA-p77j-4mvh-x3m3). [[PR 6735](https://github.com/grafana/tempo/pull/6735)]
- Updated `github.com/go-jose/go-jose/v4` to v4.1.4 to address [CVE-2026-34986](https://github.com/advisories/GHSA-78h2-9frx-2jm8). [[PR 6852](https://github.com/grafana/tempo/pull/6852)]
- Updated `github.com/antchfx/xpath` to v1.3.6 to address [CVE-2026-32287](https://nvd.nist.gov/vuln/detail/CVE-2026-32287). [[PR 6764](https://github.com/grafana/tempo/pull/6764)]
- Updated `github.com/buger/jsonparser` to v1.1.2 to address [GHSA-6g7g-w4f8-9c9x](https://github.com/advisories/GHSA-6g7g-w4f8-9c9x). [[PR 6744](https://github.com/grafana/tempo/pull/6744)]
...
- Fixed incorrect root span detection when spans have a `child_of` link but no parent. ([PR 5557](https://github.com/grafana/tempo/pull/5557))
