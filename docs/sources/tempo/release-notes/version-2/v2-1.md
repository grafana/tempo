...
To learn more about the TraceQL syntax, see the [TraceQL documentation](https://grafana.com/docs/tempo/<TEMPO_VERSION>/traceql/). For information on planned future extensions to the TraceQL language, see [future work](https://grafana.com/docs/tempo/<TEMPO_VERSION>/traceql/architecture/).
...
For more information, refer to the [TraceQL query editor documentation](https://grafana.com/docs/tempo/<TEMPO_VERSION>/traceql/query-editor/).
