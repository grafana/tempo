...
{{< admonition type="note" >}}
While disabling gRPC compression improves performance, it will increase data usage and network traffic, which can impact cloud billing, especially for larger clusters.
{{< /admonition >}}
