...
To learn more about instrumentation, refer to the [Set up instrumentation](./instrument-send/set-up-instrumentation/) documentation to learn how to instrument your favorite language for distributed tracing.
{{< /admonition >}}
