---
title: Upgrade to Tempo 2.x
menuTitle: Upgrade to 2.x
description: Upgrade your Grafana Tempo installation to Tempo 2.x.
weight: 550
---

# Upgrade to Tempo 2.x

<!-- vale Grafana.We = NO -->
<!-- vale Grafana.Will = NO -->
<!-- vale Grafana.Timeless = NO -->

This page covers upgrades within the Tempo 2.x release line, from Tempo 1.5 through Tempo 2.10.
For upgrading from Tempo 2.x to 3.0, refer to [Upgrade your Tempo installation](/docs/tempo/<TEMPO_VERSION>/set-up-for-tracing/setup-tempo/upgrade/).

Any release has the potential to have breaking changes.
...
This release includes breaking changes to `vParquet` block format support and deprecates older formats ahead of [Tempo 3.0](/docs/tempo/<TEMPO_VERSION>/set-up-for-tracing/setup-tempo/upgrade/#upgrade-to-tempo-30).
...
TempoDB schemas vParquet3 and vParquet2 are now deprecated and are removed in [Tempo 3.0](/docs/tempo/<TEMPO_VERSION>/set-up-for-tracing/setup-tempo/upgrade/#upgrade-to-tempo-30). [[PR 6198](https://github.com/grafana/tempo/pull/6198)]
