...
Not every claim needs a code check. Prioritize:
...
For each high-risk claim, read the relevant source file and confirm the claim is accurate. If you cannot locate the source, flag it for the human reviewer rather than assuming it is correct.
