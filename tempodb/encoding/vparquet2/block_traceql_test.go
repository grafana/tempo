...
func TestBackendBlockSearchTraceQL(t *testing.T) {
	...
	searchesThatMatch := []traceql.FetchSpansRequest{
		...
		traceql.MustExtractFetchSpansRequestWithMetadata(`{` + LabelStatusMessage + ` = "STATUS_CODE_ERROR"}`),
	...
	searchesThatDontMatch := []traceql.FetchSpansRequest{
		...
		traceql.MustExtractFetchSpansRequestWithMetadata(`{` + LabelStatusMessage + ` = "abc"}`),                  // Intrinsic: statusMessage
