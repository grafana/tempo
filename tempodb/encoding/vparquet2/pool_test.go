...
func TestSpanPoolRelease(t *testing.T) {
	...
	span1.attributes[traceql.NewIntrinsic(traceql.IntrinsicName)] = traceql.NewStaticString("test")
	span1.attributes[traceql.NewAttribute("custom")] = traceql.NewStaticInt(42)
	...
	assert.Len(t, span2.attributes, 0, "attributes should be cleared")
}
