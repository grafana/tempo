...
func traceToParquet(meta *backend.BlockMeta, id common.ID, tr *tempopb.Trace, ot *Trace) *Trace {
	...
	dedicatedResourceAttributes := dedicatedColumnsToColumnMapping(meta.DedicatedColumns, dedicatedColumnScopeResource)
	dedicatedSpanAttributes := dedicatedColumnsToColumnMapping(meta.DedicatedColumns, dedicatedColumnScopeSpan)
