...
type Span struct {
	...
	Attrs                  []ArrayAttribute `parquet:",list"`
...
func attrToParquet(a *v1.KeyValue, p *ArrayAttribute) {
	p.Key = a.Key
	p.Value = nil
	p.ValueArray = ""
	p.ValueBool = nil
	...
	case *v1.AnyValue_StringValue:
		p.Value = []string{v.StringValue}
	case *v1.AnyValue_IntValue:
		p.ValueInt = []int64{v.IntValue}
	case *v1.AnyValue_DoubleValue:
		p.ValueDouble = []float64{v.DoubleValue}
	case *v1.AnyValue_BoolValue:
		p.ValueBool = []bool{v.BoolValue}
...
func parquetToProtoAttrs(parquetAttrs []ArrayAttribute) []*v1.KeyValue {
