		...
		ResourceSpans: []ResourceSpans{
			{
				Resource: Resource{
					...
					Attrs: []ArrayAttribute{
						{Key: "foo", Value: []string{"abc"}},
						{Key: LabelServiceName, ValueInt: []int64{123}}, // Different type than dedicated column
					},
						...
						Spans: []Span{
							{
								...
								Attrs: []ArrayAttribute{
									{Key: "foo", Value: []string{"def"}},
									{Key: "bar", ValueInt: []int64{123}},
									{Key: "float", ValueDouble: []float64{456.78}},
									{Key: "bool", ValueBool: []bool{false}},

									// Edge-cases
									{Key: LabelName, Value: []string{"Bob"}},                    // Conflicts with intrinsic but still looked up by .name
									{Key: LabelServiceName, Value: []string{"spanservicename"}}, // Overrides resource-level dedicated column
									{Key: LabelHTTPStatusCode, Value: []string{"500ouch"}},      // Different type than dedicated column
								},
								Events: []Event{
...
func BenchmarkBackendBlockTraceQL(b *testing.B) {
	...
	blockID := uuid.MustParse("0115db62-40a0-4f94-b7fa-9f8e561bb820")
...
func BenchmarkBlockIO(b *testing.B){
	...
	in, err := os.Open("./test-data/337385/0115db62-40a0-4f94-b7fa-9f8e561bb820/data.parquet")
	require.NoError(b, err)
	defer in.Close()
...
func BenchmarkBackendBlockGetMetrics(b *testing.B) {
	...
	/*
		{"format":"vParquet3","blockID":"0115db62-40a0-4f94-b7fa-9f8e561bb819",
		"minID":"AAAAAAAAAAAACCJ+83BXQw==","maxID":"///o6yxCT1SVfKnyFGs+fg==","tenantID":"337385",
		"startTime":"2023-10-22T07:44:45Z","endTime":"2023-10-22T08:07:01Z","totalObjects":2079380,
		"size":650147613,"compactionLevel":3,"encoding":"none","indexPageSize":0,"totalRecords":15,
		"dataEncoding":"","bloomShards":30,"footerSize":502506}
	*/
	r, _, _, err := local.New(&local.Config{
		Path: path.Join("/Users/jenniepham/grafana/data/"),
	})
