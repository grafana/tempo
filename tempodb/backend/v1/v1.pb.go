...
import (
	...
	github_com_grafana_tempo_tempodb_backend "github.com/grafana/tempo/tempodb/backend"
	io "io"
	math "math"
	math_bits "math/bits"
	time "time"
...
type BlockMeta struct {
	...
	Encoding          *github_com_grafana_tempo_tempodb_backend.Encoding `protobuf:"bytes,11,opt,name=encoding,proto3,customtype=github.com/grafana/tempo/tempodb/backend.Encoding" json:"encoding,omitempty"`
...
var fileDescriptor_6bc10ae735c1a340 = []byte{
	...
	,
}
...
func (m *BlockMeta) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			...
			m.Encoding = github_com_grafana_tempo_tempodb_backend.Encoding(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 12:
			if wireType != 0 {
