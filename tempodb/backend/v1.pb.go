...
type TenantIndex struct {
	...
	CompactedMetas []*CompactedBlockMeta `protobuf:"bytes,3,rep,name=compacted_metas,json=compactedMetas,proto3" json:"compacted_metas,omitempty"`
}
...
func (m *TenantIndex) GetMetas() []*BlockMeta {
	if m != nil {
		return m.Metas
	}
	return nil
...
func (m *TenantIndex) GetCompactedMetas() []*CompactedBlockMeta {
	if m != nil {
		return m.CompactedMetas
	}
	return nil
}
...
var fileDescriptor_6bc10ae735c1a340 = []byte{
	...
	,
}
...
func (m *TenantIndex) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.CompactedMetas) > 0 {
		for iNdEx := len(m.CompactedMetas) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.CompactedMetas[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *TenantIndex) Size() (n int) {
	...
	if len(m.CompactedMetas) > 0 {
		for _, e := range m.CompactedMetas {
			l = e.Size()
			n += 1 + l + sovV1(uint64(l))
		}
	}
...
func (m *TenantIndex) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Metas = append(m.Metas, &BlockMeta{})
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CompactedMetas", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CompactedMetas = append(m.CompactedMetas, &CompactedBlockMeta{})
			if err := m.CompactedMetas[len(m.CompactedMetas)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
