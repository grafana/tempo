...
func GetContainerURL(ctx context.Context, cfg *config.Config, hedge bool) (blob.ContainerURL, error) {
	var err error
...
func GetContainer(ctx context.Context, conf *config.Config, hedge bool) (blob.ContainerURL, error) {
...
func GetBlobURL(ctx context.Context, conf *config.Config, blobName string) (blob.BlockBlobURL, error) {
...
func CreateContainer(ctx context.Context, conf *config.Config) (blob.ContainerURL, error) {
	c, err := GetContainerURL(ctx, conf, false)
	if err != nil {
		return blob.ContainerURL{}, err
	}
...
func getOAuthToken(cfg *config.Config) (*blob.TokenCredential, error) {
...
func getServicePrincipalToken(cfg *config.Config) (*adal.ServicePrincipalToken, error) {
