...
func TestWriter(t *testing.T) {
	...
	meta := NewBlockMeta("test", u, "blerg", "glarg")
...
func TestReader(t *testing.T) {
	...
	expectedMeta := NewBlockMeta("test", uuid.New(), "blerg", "glarg")
...
func TestRoundTripMeta(t *testing.T) {
	...
	meta := NewBlockMeta("test", uuid.New(), "blerg", "glarg")
	// RoundTrip with empty DedicatedColumns
...
func TestTenantIndexFallback(t *testing.T) {
	var (
		...
		u           = uuid.New()
		meta        = NewBlockMeta(tenantID, u, "blerg", "glarg")
