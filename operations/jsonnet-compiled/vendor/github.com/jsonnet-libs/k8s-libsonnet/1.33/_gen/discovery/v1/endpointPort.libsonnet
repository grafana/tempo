{
  ...
  '#withPort':: d.fn(help="\"port represents the port number of the endpoint. If the EndpointSlice is derived from a Kubernetes service, this must be set to the service's target port. EndpointSlices used for other purposes may have a nil port.\"", args=[d.arg(name='port', type=d.T.integer)]),
