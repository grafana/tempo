{
  ...
  '#':: d.pkg(name='storageVersionMigration', url='', help='"StorageVersionMigration represents a migration of stored data to the latest storage version."'),
  ...
  '#new':: d.fn(help='new returns an instance of StorageVersionMigration', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'storagemigration.k8s.io/v1alpha1',
    kind: 'StorageVersionMigration',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"Spec of the storage version migration."'),
  spec: {
    ...
    withContinueToken(continueToken): { spec+: { continueToken: continueToken } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
