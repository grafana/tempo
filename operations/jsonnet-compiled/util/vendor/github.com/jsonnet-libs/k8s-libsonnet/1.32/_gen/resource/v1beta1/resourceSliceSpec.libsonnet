{
  ...
  '#withAllNodes':: d.fn(help='"AllNodes indicates that all nodes have access to the resources in the pool.\\n\\nExactly one of NodeName, NodeSelector and AllNodes must be set."', args=[d.arg(name='allNodes', type=d.T.boolean)]),
