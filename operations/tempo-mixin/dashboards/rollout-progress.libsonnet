...
local filename = 'tempo-rollout-progress.json';
...
(import 'dashboard-utils.libsonnet') {
  local config = {
    ...
    all_services_regex: '.*(%s).*' % std.join('|', ['cortex-gw', 'distributor', 'live-store', 'query-frontend', 'querier', 'compactor', 'metrics-generator']),
  },
