...
metricsAggregation:
    ...
    | AVG_OVER_TIME OPEN_PARENS attribute CLOSE_PARENS                                                                  { $$ = newMetricsAverageAggregateWithAttr($3, nil) }
    | AVG_OVER_TIME OPEN_PARENS attribute CLOSE_PARENS BY OPEN_PARENS attributeList CLOSE_PARENS                        { $$ = newMetricsAverageAggregateWithAttr($3, $7) }
