...
func TestAttributes(t *testing.T) {
	tests := []struct {
		...
		{in: "scope.foo.bar", expected: NewScopedAttribute(AttributeScopeInstrumentation, false, "foo.bar")},
...
func TestScopedIntrinsics(t *testing.T) {
	tests := []struct {
		...
		{in: "scope:name", expected: IntrinsicScopeName},
		{in: "scope:version", expected: IntrinsicScopeVersion},
