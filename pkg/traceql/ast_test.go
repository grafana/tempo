...
func (m *mockSpan) SiblingOf(lhs []Span, rhs []Span, falseForAll bool, union bool, _ []Span) []Span {
...
func (m *mockSpan) ChildOf(lhs []Span, rhs []Span, falseForAll bool, invert bool, union bool, _ []Span) []Span {
