...
func (m *mockSpan) DescendantOf(l []Span, r []Span, invert bool) []Span { // jpe - fix
...
func (m *mockSpan) SiblingOf(l []Span, r []Span, invert bool) []Span {
	// if ss, ok := s.(*mockSpan); ok {
...
func (m *mockSpan) ChildOf(l []Span, r []Span, invert bool) []Span {
	// if ss, ok := s.(*mockSpan); ok {
