...
type RedactionBatch struct {
	...
	// quiescence_ticks_remaining holds a completed batch open for a few maintenance ticks
	// before removal, so compaction stays disabled long enough for the rescan to catch any
	// block a compaction produced just as the last redaction job finished. 0 means the batch
	// is not yet in quiescence (still in progress); it is set when all jobs complete and
	// decremented each maintenance tick, with the batch removed when it reaches 0.
	QuiescenceTicksRemaining int32 `protobuf:"varint,9,opt,name=quiescence_ticks_remaining,json=quiescenceTicksRemaining,proto3" json:"quiescence_ticks_remaining,omitempty"`
}
...
func (m *RedactionBatch) GetQuiescenceTicksRemaining() int32 {
	if m != nil {
		return m.QuiescenceTicksRemaining
	}
	return 0
}
...
var fileDescriptor_1e9b87dd365f5504 = []byte{
	...
	,
}
...
func (this *RedactionBatch) Equal(that interface{}) bool {
	...
	if this.QuiescenceTicksRemaining != that1.QuiescenceTicksRemaining {
		return false
	}
	return true
}
...
func (m *RedactionBatch) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.QuiescenceTicksRemaining != 0 {
		i = encodeVarintBackendwork(dAtA, i, uint64(m.QuiescenceTicksRemaining))
		i--
		dAtA[i] = 0x48
	}
	if m.Mode != 0 {
...
func (m *RedactionBatch) Size() (n int) {
	...
	if m.QuiescenceTicksRemaining != 0 {
		n += 1 + sovBackendwork(uint64(m.QuiescenceTicksRemaining))
	}
	return n
}
...
func (m *RedactionBatch) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field QuiescenceTicksRemaining", wireType)
			}
			m.QuiescenceTicksRemaining = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowBackendwork
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.QuiescenceTicksRemaining |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
