...
func (m *RedactionDetail) GetVerify() bool {
	if m != nil {
		return m.Verify
	}
	return false
...
type RedactionBatch struct {
	...
	// verify_rounds counts the verification passes run for this batch. Persisted so a scheduler
	// restart resumes the count rather than resetting it, which would let a batch that keeps finding
	// matches re-verify forever and hold the tenant's compaction off indefinitely.
	VerifyRounds int32 `protobuf:"varint,12,opt,name=verify_rounds,json=verifyRounds,proto3" json:"verify_rounds,omitempty"`
	// verified records that the most recent verification pass completed without finding a match, so
	// the batch may quiesce. Without it a drained batch is indistinguishable from one that has never
	// been verified, and every sweep would launch another pass until the round budget ran out --
	// making a clean redaction look like one that failed to converge.
	//
	// Set when a pass is launched and cleared by any job in that pass reporting a match, so a finding
	// both repairs the block and puts the batch back in line for another pass.
...
func (m *RedactionBatch) GetVerifyRounds() int32 {
	if m != nil {
		return m.VerifyRounds
	}
	return 0
}

func (m *RedactionBatch) GetVerified() bool {
	if m != nil {
		return m.Verified
	}
	return false
...
var fileDescriptor_1e9b87dd365f5504 = []byte{
	...
	,
}
...
func (this *RedactionBatch) Equal(that interface{}) bool {
	...
	if this.VerifyRounds != that1.VerifyRounds {
		return false
	}
...
func (m *RedactionBatch) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.VerifyRounds != 0 {
		i = encodeVarintBackendwork(dAtA, i, uint64(m.VerifyRounds))
		i--
		dAtA[i] = 0x60
	}
	if m.EndTimeUnixNano != 0 {
...
func (m *RedactionBatch) Size() (n int) {
	...
	if m.VerifyRounds != 0 {
		n += 1 + sovBackendwork(uint64(m.VerifyRounds))
	}
	if m.Verified {
		n += 2
	}
...
func (m *RedactionBatch) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field VerifyRounds", wireType)
			}
			m.VerifyRounds = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.VerifyRounds |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
