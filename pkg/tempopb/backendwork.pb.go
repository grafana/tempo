...
type RedactionBatch struct {
	...
	// rescan_generation is incremented each time the scheduler re-arms the rescan
	// timer because newly-produced output blocks are themselves being compacted.
	RescanGeneration int32 `protobuf:"varint,7,opt,name=rescan_generation,json=rescanGeneration,proto3" json:"rescan_generation,omitempty"`
}
...
func (m *RedactionBatch) GetRescanGeneration() int32 {
	if m != nil {
		return m.RescanGeneration
	}
	return 0
}
...
var fileDescriptor_1e9b87dd365f5504 = []byte{
	...
	,
}
...
func (this *RedactionBatch) Equal(that interface{}) bool {
	...
	if this.RescanGeneration != that1.RescanGeneration {
		return false
	}
	return true
}
...
func (m *RedactionBatch) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.RescanGeneration != 0 {
		i = encodeVarintBackendwork(dAtA, i, uint64(m.RescanGeneration))
		i--
		dAtA[i] = 0x38
	}
...
func (m *RedactionBatch) Size() (n int) {
	...
	if m.RescanGeneration != 0 {
		n += 1 + sovBackendwork(uint64(m.RescanGeneration))
	}
	return n
}
...
func (m *RedactionBatch) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RescanGeneration", wireType)
			}
			m.RescanGeneration = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowBackendwork
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RescanGeneration |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
