...
func (m *TraceByIDRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.QueryMode) > 0 {
		...
		if len(m.QueryMode) <= 0x7F {
			dAtA[i-1] = uint8(len(m.QueryMode))
			i--
		} else {
	...
	if len(m.BlockEnd) > 0 {
		...
		if len(m.BlockEnd) <= 0x7F {
			dAtA[i-1] = uint8(len(m.BlockEnd))
			i--
		} else {
	...
	if len(m.BlockStart) > 0 {
		...
		if len(m.BlockStart) <= 0x7F {
			dAtA[i-1] = uint8(len(m.BlockStart))
			i--
		} else {
...
func (m *SearchRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	for iNdEx := len(m.SkipASTTransformations) - 1; iNdEx >= 0; iNdEx-- {
		...
		if len(m.SkipASTTransformations[iNdEx]) <= 0x7F {
			dAtA[i-1] = uint8(len(m.SkipASTTransformations[iNdEx]))
			i--
		} else {
...
func (m *TraceSearchMetadata) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RootTraceName) > 0 {
		...
		if len(m.RootTraceName) <= 0x7F {
			dAtA[i-1] = uint8(len(m.RootTraceName))
			i--
		} else {
	...
	if len(m.RootServiceName) > 0 {
		...
		if len(m.RootServiceName) <= 0x7F {
			dAtA[i-1] = uint8(len(m.RootServiceName))
			i--
		} else {
...
func (m *SearchTagsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	for iNdEx := len(m.TagNames) - 1; iNdEx >= 0; iNdEx-- {
		...
		if len(m.TagNames[iNdEx]) <= 0x7F {
			dAtA[i-1] = uint8(len(m.TagNames[iNdEx]))
			i--
		} else {
...
func (m *SearchTagsV2Scope) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	for iNdEx := len(m.Tags) - 1; iNdEx >= 0; iNdEx-- {
		...
		if len(m.Tags[iNdEx]) <= 0x7F {
			dAtA[i-1] = uint8(len(m.Tags[iNdEx]))
			i--
		} else {
...
func (m *SearchTagValuesRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TagName) > 0 {
		...
		if len(m.TagName) <= 0x7F {
			dAtA[i-1] = uint8(len(m.TagName))
			i--
		} else {
...
func (m *SearchTagValuesResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	for iNdEx := len(m.TagValues) - 1; iNdEx >= 0; iNdEx-- {
		...
		if len(m.TagValues[iNdEx]) <= 0x7F {
			dAtA[i-1] = uint8(len(m.TagValues[iNdEx]))
			i--
		} else {
...
func (m *TraceBytes) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	for iNdEx := len(m.Traces) - 1; iNdEx >= 0; iNdEx-- {
		...
		if len(m.Traces[iNdEx]) <= 0x7F {
			dAtA[i-1] = uint8(len(m.Traces[iNdEx]))
			i--
		} else {
...
func (m *SearchRequest) UnmarshalNoPrescan(dAtA []byte) error {
...
func (m *SearchBlockRequest) UnmarshalNoPrescan(dAtA []byte) error {
	return m.unmarshal(dAtA, -1)
}
...
func (m *SearchResponse) UnmarshalNoPrescan(dAtA []byte) error {
	return m.unmarshal(dAtA, -1)
}
...
func (m *TraceSearchMetadata) UnmarshalNoPrescan(dAtA []byte) error {
	return m.unmarshal(dAtA, -1)
}
...
func (m *SpanSet) UnmarshalNoPrescan(dAtA []byte) error {
	return m.unmarshal(dAtA, -1)
}
...
func (m *SearchTagsBlockRequest) UnmarshalNoPrescan(dAtA []byte) error {
	return m.unmarshal(dAtA, -1)
}
...
func (m *SearchTagValuesBlockRequest) UnmarshalNoPrescan(dAtA []byte) error {
	return m.unmarshal(dAtA, -1)
}
...
func (m *SearchTagsResponse) UnmarshalNoPrescan(dAtA []byte) error {
	return m.unmarshal(dAtA, -1)
}
...
func (m *SearchTagsV2Response) UnmarshalNoPrescan(dAtA []byte) error {
	return m.unmarshal(dAtA, -1)
}
...
func (m *SearchTagsV2Scope) UnmarshalNoPrescan(dAtA []byte) error {
	return m.unmarshal(dAtA, -1)
}
...
func (m *SearchTagValuesResponse) UnmarshalNoPrescan(dAtA []byte) error {
	return m.unmarshal(dAtA, -1)
}
...
func (m *SearchTagValuesV2Response) UnmarshalNoPrescan(dAtA []byte) error {
	return m.unmarshal(dAtA, -1)
}
...
func (m *Trace) UnmarshalNoPrescan(dAtA []byte) error {
	return m.unmarshal(dAtA, -1)
}
...
func (m *PushBytesRequest) UnmarshalNoPrescan(dAtA []byte) error {
	return m.unmarshal(dAtA, -1)
}
...
func (m *PushSpansRequest) UnmarshalNoPrescan(dAtA []byte) error {
	return m.unmarshal(dAtA, -1)
}
...
func (m *TraceBytes) UnmarshalNoPrescan(dAtA []byte) error {
	return m.unmarshal(dAtA, -1)
}
...
func (m *LinkSlice) UnmarshalNoPrescan(dAtA []byte) error {
	return m.unmarshal(dAtA, -1)
}
...
func (m *QueryInstantResponse) UnmarshalNoPrescan(dAtA []byte) error {
	return m.unmarshal(dAtA, -1)
}
...
func (m *InstantSeries) UnmarshalNoPrescan(dAtA []byte) error {
	return m.unmarshal(dAtA, -1)
}
...
func (m *QueryRangeRequest) UnmarshalNoPrescan(dAtA []byte) error {
	return m.unmarshal(dAtA, -1)
}
...
func (m *QueryRangeResponse) UnmarshalNoPrescan(dAtA []byte) error {
	return m.unmarshal(dAtA, -1)
}
