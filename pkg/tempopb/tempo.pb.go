...
type TracesCheckRequest struct {
	...
	TimeStart  uint32   `protobuf:"varint,5,opt,name=timeStart,proto3" json:"timeStart,omitempty"`
	TimeEnd    uint32   `protobuf:"varint,6,opt,name=timeEnd,proto3" json:"timeEnd,omitempty"`
}

func (m *TracesCheckRequest) Reset()         { *m = TracesCheckRequest{} }
func (m *TracesCheckRequest) String() string { return proto.CompactTextString(m) }
func (*TracesCheckRequest) ProtoMessage()    {}
func (*TracesCheckRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f22805646f4f62b6, []int{49}
}
func (m *TracesCheckRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TracesCheckRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TracesCheckRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TracesCheckRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TracesCheckRequest.Merge(m, src)
}
func (m *TracesCheckRequest) XXX_Size() int {
	return m.Size()
}
func (m *TracesCheckRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_TracesCheckRequest.DiscardUnknown(m)
}

var xxx_messageInfo_TracesCheckRequest proto.InternalMessageInfo

func (m *TracesCheckRequest) GetTraceIDs() []string {
	if m != nil {
		return m.TraceIDs
	}
	return nil
...
func (m *TracesCheckRequest) GetBlockStart() string {
	if m != nil {
		return m.BlockStart
	}
	return ""
...
func (m *TracesCheckRequest) GetBlockEnd() string {
	if m != nil {
		return m.BlockEnd
	}
	return ""
...
func (m *TracesCheckRequest) GetQueryMode() string {
	if m != nil {
		return m.QueryMode
	}
	return ""
...
func (m *TracesCheckRequest) GetTimeStart() uint32 {
	if m != nil {
		return m.TimeStart
	}
	return 0
...
func (m *TracesCheckRequest) GetTimeEnd() uint32 {
	if m != nil {
		return m.TimeEnd
	}
	return 0
...
type TracesCheckResponse struct {
	TraceIDs []string          `protobuf:"bytes,1,rep,name=traceIDs,proto3" json:"traceIDs,omitempty"`
	Metrics  *TraceByIDMetrics `protobuf:"bytes,2,opt,name=metrics,proto3" json:"metrics,omitempty"`
}

func (m *TracesCheckResponse) Reset()         { *m = TracesCheckResponse{} }
func (m *TracesCheckResponse) String() string { return proto.CompactTextString(m) }
func (*TracesCheckResponse) ProtoMessage()    {}
func (*TracesCheckResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f22805646f4f62b6, []int{50}
}
func (m *TracesCheckResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TracesCheckResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TracesCheckResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TracesCheckResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TracesCheckResponse.Merge(m, src)
}
func (m *TracesCheckResponse) XXX_Size() int {
	return m.Size()
}
func (m *TracesCheckResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_TracesCheckResponse.DiscardUnknown(m)
}

var xxx_messageInfo_TracesCheckResponse proto.InternalMessageInfo

func (m *TracesCheckResponse) GetTraceIDs() []string {
	if m != nil {
		return m.TraceIDs
	}
	return nil
...
func (m *TracesCheckResponse) GetMetrics() *TraceByIDMetrics {
	if m != nil {
		return m.Metrics
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*TracesCheckRequest)(nil), "tempopb.TracesCheckRequest")
	proto.RegisterType((*TracesCheckResponse)(nil), "tempopb.TracesCheckResponse")
}
...
var fileDescriptor_f22805646f4f62b6 = []byte{
	...
	,
}
...
type QuerierClient interface {
	...
	TracesCheck(ctx context.Context, in *TracesCheckRequest, opts ...grpc.CallOption) (*TracesCheckResponse, error)
...
func (c *querierClient) TracesCheck(ctx context.Context, in *TracesCheckRequest, opts ...grpc.CallOption) (*TracesCheckResponse, error) {
	out := new(TracesCheckResponse)
	err := c.cc.Invoke(ctx, "/tempopb.Querier/TracesCheck", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QuerierServer interface {
	...
	TracesCheck(context.Context, *TracesCheckRequest) (*TracesCheckResponse, error)
...
func (*UnimplementedQuerierServer) TracesCheck(ctx context.Context, req *TracesCheckRequest) (*TracesCheckResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TracesCheck not implemented")
}
...
func _Querier_TracesCheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TracesCheckRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QuerierServer).TracesCheck(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tempopb.Querier/TracesCheck",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QuerierServer).TracesCheck(ctx, req.(*TracesCheckRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Querier_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "TracesCheck",
			Handler:    _Querier_TracesCheck_Handler,
		},
		{
...
func (m *TracesCheckRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TracesCheckRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TracesCheckRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.TimeEnd != 0 {
		i = encodeVarintTempo(dAtA, i, uint64(m.TimeEnd))
		i--
		dAtA[i] = 0x30
	}
	if m.TimeStart != 0 {
		i = encodeVarintTempo(dAtA, i, uint64(m.TimeStart))
		i--
		dAtA[i] = 0x28
	}
	if len(m.QueryMode) > 0 {
...
func (m *TracesCheckResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TracesCheckResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TracesCheckResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TracesCheckRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.TimeStart != 0 {
		n += 1 + sovTempo(uint64(m.TimeStart))
	}
	if m.TimeEnd != 0 {
		n += 1 + sovTempo(uint64(m.TimeEnd))
	}
	return n
}

func (m *TracesCheckResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TracesCheckRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TracesCheckRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TracesCheckRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *TracesCheckResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TracesCheckResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TracesCheckResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
