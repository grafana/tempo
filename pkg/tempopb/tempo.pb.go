...
type TraceByIDResponse_TraceType int32

const (
	TraceByIDResponse_COMPLETE TraceByIDResponse_TraceType = 0
	TraceByIDResponse_PARTIAL  TraceByIDResponse_TraceType = 1
)

var TraceByIDResponse_TraceType_name = map[int32]string{
	0: "COMPLETE",
	1: "PARTIAL",
}

var TraceByIDResponse_TraceType_value = map[string]int32{
	"COMPLETE": 0,
	"PARTIAL":  1,
}

func (x TraceByIDResponse_TraceType) String() string {
	return proto.EnumName(TraceByIDResponse_TraceType_name, int32(x))
}

func (TraceByIDResponse_TraceType) EnumDescriptor() ([]byte, []int) {
...
type TraceByIDResponse struct {
	...
	TraceType TraceByIDResponse_TraceType `protobuf:"varint,3,opt,name=traceType,proto3,enum=tempopb.TraceByIDResponse_TraceType" json:"traceType,omitempty"`
...
func (m *TraceByIDResponse) GetTraceType() TraceByIDResponse_TraceType {
	if m != nil {
		return m.TraceType
	}
...
func init() {
	...
	proto.RegisterEnum("tempopb.TraceByIDResponse_TraceType", TraceByIDResponse_TraceType_name, TraceByIDResponse_TraceType_value)
...
var fileDescriptor_f22805646f4f62b6 = []byte{
	...
	,
}
...
func (m *TraceByIDResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.TraceType != 0 {
		i = encodeVarintTempo(dAtA, i, uint64(m.TraceType))
		i--
		dAtA[i] = 0x18
	}
	if m.Metrics != nil {
...
func (m *TraceByIDResponse) Size() (n int) {
	...
	if m.TraceType != 0 {
		n += 1 + sovTempo(uint64(m.TraceType))
	}
	l = len(m.Message)
	if l > 0 {
		n += 1 + l + sovTempo(uint64(l))
...
func (m *TraceByIDResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TraceType", wireType)
			}
			m.TraceType = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TraceType |= TraceByIDResponse_TraceType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
