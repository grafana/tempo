...
type SpanSummaryRequest struct {
	// tagFilter is a list of tags to filter on in the form of a traceql query, ie: tag=value
	TagFilter []string `protobuf:"bytes,1,rep,name=tagFilter,proto3" json:"tagFilter,omitempty"`
	GroupBy   string   `protobuf:"bytes,2,opt,name=groupBy,proto3" json:"groupBy,omitempty"`
}

func (m *SpanSummaryRequest) Reset()         { *m = SpanSummaryRequest{} }
func (m *SpanSummaryRequest) String() string { return proto.CompactTextString(m) }
func (*SpanSummaryRequest) ProtoMessage()    {}
func (*SpanSummaryRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f22805646f4f62b6, []int{24}
}
func (m *SpanSummaryRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SpanSummaryRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SpanSummaryRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SpanSummaryRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SpanSummaryRequest.Merge(m, src)
}
func (m *SpanSummaryRequest) XXX_Size() int {
	return m.Size()
}
func (m *SpanSummaryRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_SpanSummaryRequest.DiscardUnknown(m)
}

var xxx_messageInfo_SpanSummaryRequest proto.InternalMessageInfo

func (m *SpanSummaryRequest) GetTagFilter() []string {
	if m != nil {
		return m.TagFilter
	}
	return nil
...
func (m *SpanSummaryRequest) GetGroupBy() string {
	if m != nil {
		return m.GroupBy
	}
	return ""
...
type SpanSummaryResponse struct {
	Stats []*SpanSummaryGroup `protobuf:"bytes,1,rep,name=stats,proto3" json:"stats,omitempty"`
}

func (m *SpanSummaryResponse) Reset()         { *m = SpanSummaryResponse{} }
func (m *SpanSummaryResponse) String() string { return proto.CompactTextString(m) }
func (*SpanSummaryResponse) ProtoMessage()    {}
func (*SpanSummaryResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f22805646f4f62b6, []int{25}
}
func (m *SpanSummaryResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SpanSummaryResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SpanSummaryResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SpanSummaryResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SpanSummaryResponse.Merge(m, src)
}
func (m *SpanSummaryResponse) XXX_Size() int {
	return m.Size()
}
func (m *SpanSummaryResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_SpanSummaryResponse.DiscardUnknown(m)
}

var xxx_messageInfo_SpanSummaryResponse proto.InternalMessageInfo

func (m *SpanSummaryResponse) GetStats() []*SpanSummaryGroup {
	if m != nil {
		return m.Stats
	}
	return nil
...
type SpanSummaryGroup struct {
	Name           string             `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	SpanCount      int64              `protobuf:"varint,2,opt,name=spanCount,proto3" json:"spanCount,omitempty"`
	ErrorSpanCount int64              `protobuf:"varint,3,opt,name=errorSpanCount,proto3" json:"errorSpanCount,omitempty"`
	Latencies      map[string]float64 `protobuf:"bytes,4,rep,name=latencies,proto3" json:"latencies,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"fixed64,2,opt,name=value,proto3"`
}

func (m *SpanSummaryGroup) Reset()         { *m = SpanSummaryGroup{} }
func (m *SpanSummaryGroup) String() string { return proto.CompactTextString(m) }
func (*SpanSummaryGroup) ProtoMessage()    {}
func (*SpanSummaryGroup) Descriptor() ([]byte, []int) {
	return fileDescriptor_f22805646f4f62b6, []int{26}
}
func (m *SpanSummaryGroup) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SpanSummaryGroup) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SpanSummaryGroup.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SpanSummaryGroup) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SpanSummaryGroup.Merge(m, src)
}
func (m *SpanSummaryGroup) XXX_Size() int {
	return m.Size()
}
func (m *SpanSummaryGroup) XXX_DiscardUnknown() {
	xxx_messageInfo_SpanSummaryGroup.DiscardUnknown(m)
}

var xxx_messageInfo_SpanSummaryGroup proto.InternalMessageInfo

func (m *SpanSummaryGroup) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *SpanSummaryGroup) GetSpanCount() int64 {
	if m != nil {
		return m.SpanCount
	}
	return 0
...
func (m *SpanSummaryGroup) GetErrorSpanCount() int64 {
	if m != nil {
...
func (m *SpanSummaryGroup) GetLatencies() map[string]float64 {
	if m != nil {
		return m.Latencies
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*SpanSummaryRequest)(nil), "tempopb.SpanSummaryRequest")
	proto.RegisterType((*SpanSummaryResponse)(nil), "tempopb.SpanSummaryResponse")
	proto.RegisterType((*SpanSummaryGroup)(nil), "tempopb.SpanSummaryGroup")
	proto.RegisterMapType((map[string]float64)(nil), "tempopb.SpanSummaryGroup.LatenciesEntry")
}
...
var fileDescriptor_f22805646f4f62b6 = []byte{
	...
	,
}
...
type MetricsGeneratorClient interface {
	...
	SpanSummary(ctx context.Context, in *SpanSummaryRequest, opts ...grpc.CallOption) (*SpanSummaryResponse, error)
}
...
func (c *metricsGeneratorClient) SpanSummary(ctx context.Context, in *SpanSummaryRequest, opts ...grpc.CallOption) (*SpanSummaryResponse, error) {
	out := new(SpanSummaryResponse)
	err := c.cc.Invoke(ctx, "/tempopb.MetricsGenerator/SpanSummary", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MetricsGeneratorServer interface {
	...
	SpanSummary(context.Context, *SpanSummaryRequest) (*SpanSummaryResponse, error)
}
...
func (*UnimplementedMetricsGeneratorServer) SpanSummary(ctx context.Context, req *SpanSummaryRequest) (*SpanSummaryResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SpanSummary not implemented")
}
...
func _MetricsGenerator_SpanSummary_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SpanSummaryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MetricsGeneratorServer).SpanSummary(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tempopb.MetricsGenerator/SpanSummary",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MetricsGeneratorServer).SpanSummary(ctx, req.(*SpanSummaryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _MetricsGenerator_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SpanSummary",
			Handler:    _MetricsGenerator_SpanSummary_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "pkg/tempopb/tempo.proto",
...
func (m *SpanSummaryRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SpanSummaryRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SpanSummaryRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.TagFilter) > 0 {
		for iNdEx := len(m.TagFilter) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.TagFilter[iNdEx])
			copy(dAtA[i:], m.TagFilter[iNdEx])
			i = encodeVarintTempo(dAtA, i, uint64(len(m.TagFilter[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *SpanSummaryResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SpanSummaryResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SpanSummaryResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *SpanSummaryGroup) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SpanSummaryGroup) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SpanSummaryGroup) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *SpanSummaryRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SpanSummaryResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SpanSummaryGroup) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if len(m.Latencies) > 0 {
		for k, v := range m.Latencies {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovTempo(uint64(len(k))) + 1 + 8
			n += mapEntrySize + 1 + sovTempo(uint64(mapEntrySize))
		}
	}
	return n
...
func (m *SpanSummaryRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SpanSummaryRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SpanSummaryRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.TagFilter = append(m.TagFilter, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
...
func (m *SpanSummaryResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SpanSummaryResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SpanSummaryResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Stats = append(m.Stats, &SpanSummaryGroup{})
...
func (m *SpanSummaryGroup) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SpanSummaryGroup: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SpanSummaryGroup: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ErrorSpanCount |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
