...
type Span struct {
	...
	ParentSpanId SpanID `protobuf:"bytes,4,opt,name=parent_span_id,json=parentSpanId,proto3,customtype=SpanID" json:"parent_span_id"`
	// Flags, a bit field.
	//
...
var fileDescriptor_a52825641200f25e = []byte{
	...
	,
}
