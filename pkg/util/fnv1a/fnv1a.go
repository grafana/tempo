...
const (
	...
	// Init64 is what 64-bit hash values should be initialized with.
	Init64 = offset64
)

// HashString64 returns the FNV-1a 64-bit hash of s.
...
// AddUint64 adds the hash of u's 8 bytes to h.
