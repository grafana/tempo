...
var (
	dedicatedColumnsResource = []backend.DedicatedColumn{
	...
	dedicatedColumnsSpan = []backend.DedicatedColumn{
...
func MakeDedicatedColumns() []backend.DedicatedColumn {
	columns := make([]backend.DedicatedColumn, 0, len(dedicatedColumnsResource)+len(dedicatedColumnsSpan))
