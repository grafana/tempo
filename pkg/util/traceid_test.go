...
func TestTraceIDToHexString(t *testing.T) {
	tc := []struct {
		...
		{
			byteID:  []byte{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
			traceID: "", // all-zero ID trims to empty
		},
		{
			byteID:  []byte{0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f, 0x10, 0x11},
			traceID: "102030405060708090a0b0c0d0e0f1011", // >16 bytes takes the heap fallback path
		},
	}
