...
// StringifyAnyValue renders an attribute value as a string. A nil value
// (possible in valid proto3, where the value field of a KeyValue may be
// absent) stringifies to "", same as an AnyValue with no Value set.
