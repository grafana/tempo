...
`grafana/tempo:3.0.3` image by default. To test local code, run the following from the project root
folder and either update the compose files to use `grafana/tempo:3.0.3` or tag the locally built image
as `grafana/tempo:3.0.3`:
