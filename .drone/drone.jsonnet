...
local aws_dev_access_key_id = secret('AWS_ACCESS_KEY_ID-dev', 'infra/ci/tempo-dev/aws-credentials-drone', 'access_key_id');
local aws_dev_secret_access_key = secret('AWS_SECRET_ACCESS_KEY-dev', 'infra/ci/tempo-dev/aws-credentials-drone', 'secret_access_key');
