...
* [FEATURE] Add experimental drain limiter to the metrics generator. This can reduce metrics cardinality by clustering similar span names. [](https://github.com/grafana/tempo/pull/...) (@Logiraptor)
