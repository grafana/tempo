...
* [ENHANCEMENT] MCP: eliminate unnecessary string copy in handleHTTP response path, halving memory usage per tool call [#6772](https://github.com/grafana/tempo/pull/6772) (@jordanbertasso)
