...
* [ENHANCEMENT] Enable HTTP writes in the multi-tenant example [#5297](https://github.com/grafana/tempo/pull/5297) (@carles-grafana)
* [ENHANCEMENT] Support enabling kafka writes per-tenant [#5341](https://github.com/grafana/tempo/pull/5341) (@mapno)
