...
* [FEATURE] Add query hint sample=true which provides approximate TraceQL metrics results faster by sampling a subset of the data [#5469](https://github.com/grafana/tempo/pull/5469) (@mdisibio)
