...
* [BUGFIX] Query-frontend: reject TraceQL queries that exceed `max_query_expression_size_bytes` before parsing across search, metrics, tags, and MCP query paths. [#7245](https://github.com/grafana/tempo/pull/7245) (@carles-grafana)
