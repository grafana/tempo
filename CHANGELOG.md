...
* [ENHANCEMENT] MCP: eliminate unnecessary string copy in handleHTTP response path, halving memory usage per tool call [#XXXX](https://github.com/grafana/tempo/pull/XXXX) (@jordanbertasso)
