...
* [BUGFIX] backend-scheduler: fix redaction correctness race where compaction starting after submission could leave post-compaction output blocks without a redaction job; a maintenance scan now detects the overlap and enqueues follow-up jobs. [#7183](https://github.com/grafana/tempo/pull/7183) (@zalegrala)
