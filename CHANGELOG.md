...
* [ENHANCEMENT] Add `max_partition_lag` configuration parameter to live-store to return 503 when partition lag exceeds threshold [#6211](https://github.com/grafana/tempo/pull/6211) (@oleg-kozlyuk-grafana)
