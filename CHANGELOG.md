...
* [CHANGE] Replace `segmentio/fasthash` with `cespare/xxhash/v2` for in-memory hashing, sharding, and cache-key computation - existing cache entries hashes can miss after rollout. [#7294](https://github.com/grafana/tempo/pull/7294) (@stoewer)
