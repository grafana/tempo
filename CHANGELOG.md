...
* [CHANGE] Enforce max attribute size at event, link, and instrumentation scope. Make config per-tenant [#4633](https://github.com/grafana/tempo/pull/4633) (@ie-pham)
