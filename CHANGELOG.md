...
* [BUGFIX] Fix defaults for MaxBytesPerTrace (ingester.max-search-bytes-per-trace) and MaxSearchBytesPerTrace (ingester.max-search-bytes-per-trace) (@bitprocessor)
