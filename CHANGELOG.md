...
* [CHANGE] Remove experimental websockets support for search streaming. GRPC is the supported method of streaming results [#3???](https://github.com/grafana/tempo/pull/3???) (@joe-elliott)
