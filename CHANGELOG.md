...
* [ENHANCEMENT] Add received bytes metric in ingesters [#](https://github.com/grafana/tempo/pull/) (@mapno)
* [ENHANCEMENT] Add received bytes metric in ingesters [#979](https://github.com/grafana/tempo/pull/979) (@mapno)
