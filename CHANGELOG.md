...
* [FEATURE] Add `metrics_generator_registry_demand_series` Prometheus gauge to measure the metrics-generator series demand per tenant, useful when a tenant reaches the max active series and we want to know how many they would generate in total. [#5651](https://github.com/grafana/tempo/pull/5651) (@carles-grafana)
