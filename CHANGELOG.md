...
* [FEATURE] Add automemlimit support for automatic GOMEMLIMIT configuration. Enable with `memory.automemlimit_enabled: true`. [#XXXX](https://github.com/grafana/tempo/pull/XXXX) (@oleg-kozlyuk)
