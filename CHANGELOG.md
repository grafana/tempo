...
* [ENHANCEMENT] querier: cap the external trace-by-ID response body read at the gRPC send-message size so an oversized or unbounded external response cannot exhaust the querier heap. [#7240](https://github.com/grafana/tempo/pull/7240) (@electron0zero)
