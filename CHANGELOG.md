...
* [ENHANCEMENT] Added ability to configure Parquet compression. New `parquet_compression` option supports snappy (default), lz4_raw, zstd, gzip, and none. [#6402](https://github.com/grafana/tempo/pull/6402) (@oleg-kozlyuk-grafana)
