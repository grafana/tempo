...
type ReadOverrides struct {
	...
	MaxConditionGroups         int `yaml:"max_condition_groups,omitempty" json:"max_condition_groups,omitempty"`
...
func (c *Config) RegisterFlagsAndApplyDefaults(f *flag.FlagSet) {
	...
	f.IntVar(&c.Defaults.Read.MaxConditionGroups, "querier.max-condition-groups", traceql.DefaultMaxConditionGroups, "Maximum number of OR-expanded condition groups allowed in a tag search query. Queries that expand beyond this limit will be rejected.")
