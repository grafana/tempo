...
func (base *MetricsGeneratorOverrides) Merge(other *MetricsGeneratorOverrides) MetricsGeneratorOverrides {
	return MetricsGeneratorOverrides{
		...
		NativeHistogramBucketFactor:     mergeVal(base.NativeHistogramBucketFactor, other.NativeHistogramBucketFactor),
		NativeHistogramMaxBucketNumber:  mergeVal(base.NativeHistogramMaxBucketNumber, other.NativeHistogramMaxBucketNumber),
