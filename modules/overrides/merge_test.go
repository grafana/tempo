...
func generateFullOverrides() *Overrides {
	return &Overrides{
		...
		Read: ReadOverrides{
			...
			MaxConditionGroupsPerTagQuery: 1,
		...
		MetricsGenerator: MetricsGeneratorOverrides{
			...
			NativeHistogramBucketFactor:     ptrTo(1.1),
			NativeHistogramMaxBucketNumber:  ptrTo(uint32(1)),
			...
			Processor: ProcessorOverrides{
				ServiceGraphs: ServiceGraphsOverrides{
					...
					EnableTraceStateSpanMultiplier:        ptrTo(true),
				},
