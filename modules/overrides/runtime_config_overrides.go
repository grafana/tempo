...
func loadPerTenantOverrides(validator Validator, typ ConfigType, expandEnv bool, enableLegacy bool, defaults *Overrides) func(r io.Reader) (interface{}, error) {
...
func newRuntimeConfigOverrides(cfg Config, validator Validator, registerer prometheus.Registerer) (Service, error) {
	...
	if cfg.PerTenantOverrideConfig != "" {
		runtimeCfg := runtimeconfig.Config{
			...
			Loader:       loadPerTenantOverrides(validator, cfg.ConfigType, cfg.ExpandEnv, cfg.EnableLegacyOverrides, &cfg.Defaults),
		}
