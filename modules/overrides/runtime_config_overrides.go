...
func (o *runtimeConfigOverridesManager) SpanPruningEnabledByDefault(userID string) *bool {
	return o.getOverridesForUser(userID).Read.SpanPruningEnabledByDefault
}
