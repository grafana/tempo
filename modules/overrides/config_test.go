...
func generateTestLegacyOverrides() LegacyOverrides {
	...
	return LegacyOverrides{
		...
		MetricsGeneratorProcessorServiceGraphsEnableTraceStateSpanMultiplier:        ptrTo(true),
		...
		MetricsGeneratorProcessorSpanMetricsEnableTraceStateSpanMultiplier: ptrTo(true),
		...
		MetricsGeneratorNativeHistogramBucketFactor:                        ptrTo(1.5),
		MetricsGeneratorNativeHistogramMaxBucketNumber:                     ptrTo(uint32(200)),
