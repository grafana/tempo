...
func instanceWithPushLimits(t *testing.T, maxBytes int, maxTraces int) *instance {
...
func TestInstanceLimits(t *testing.T) {
	...
	t.Run("bytes - succeeds", func(t *testing.T) {
		instance := instanceWithPushLimits(t, maxBytes, maxTraces)
...
func TestInstanceNoLimits(t *testing.T) {
	instance := instanceWithPushLimits(t, 0, 0) // no limits by default
