...
func (cfg *Config) RegisterFlagsAndApplyDefaults(prefix string, f *flag.FlagSet) {
	...
	f.UintVar(&cfg.ConcurrentBlocks, prefix+".metrics.concurrent-blocks", cfg.ConcurrentBlocks, "Number of concurrent blocks to query for metrics.")
	f.Float64Var(&cfg.TimeOverlapCutoff, prefix+".metrics.time-overlap-cutoff", cfg.TimeOverlapCutoff, "Time overlap cutoff ratio for metrics queries (0.0-1.0).")
