...
func (t *testCounter) removeStaleSeries(staleTimeMs int64) {
	panic("implement me")
}
...
func (t *testGauge) removeStaleSeries(staleTimeMs int64) {
	panic("implement me")
}
...
func (t *testHistogram) removeStaleSeries(staleTimeMs int64) {
	panic("implement me")
}
