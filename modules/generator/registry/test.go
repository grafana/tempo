...
func (t *testCounter) collectMetrics(_ storage.Appender, _ int64, _ int64) (activeSeries int, err error) {
	return
}
...
func (t *testGauge) collectMetrics(_ storage.Appender, _ int64, _ int64) (activeSeries int, err error) {
	return 0, nil
}
...
func (t *testHistogram) collectMetrics(_ storage.Appender, _ int64, _ int64) (activeSeries int, err error) {
	panic("implement me")
}
