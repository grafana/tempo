...
func Test_histogram(t *testing.T) {
	...
	h := newHistogram("my_histogram", []float64{1.0, 2.0}, onAdd, nil, "trace_id", nil, time.Duration(15*time.Minute))
...
func Test_histogram_cantAdd(t *testing.T) {
	...
	h := newHistogram("my_histogram", []float64{1.0, 2.0}, onAdd, nil, "", nil, time.Duration(15*time.Minute))
...
func Test_histogram_removeStaleSeries(t *testing.T) {
	...
	h := newHistogram("my_histogram", []float64{1.0, 2.0}, nil, onRemove, "", nil, time.Duration(15*time.Minute))
...
func Test_histogram_externalLabels(t *testing.T) {
	...
	h := newHistogram("my_histogram", []float64{1.0, 2.0}, nil, nil, "", extLabels, time.Duration(15*time.Minute))
...
func Test_histogram_concurrencyDataRace(t *testing.T) {
	h := newHistogram("my_histogram", []float64{1.0, 2.0}, nil, nil, "", nil, time.Duration(15*time.Minute))
