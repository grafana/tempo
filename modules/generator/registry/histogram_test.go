...
func Test_histogram(t *testing.T) {
	...
	h.Observe(NewLabelValues([]string{"value-1"}), 1.0, "trace-1")
	h.Observe(NewLabelValues([]string{"value-2"}), 1.5, "trace-2")
	...
	h.Observe(NewLabelValues([]string{"value-2"}), 2.5, "trace-2.2")
	h.Observe(NewLabelValues([]string{"value-3"}), 3.0, "trace-3")
