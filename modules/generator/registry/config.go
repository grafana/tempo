...
type Config struct {
	...
	// InstanceID identifies the metrics-generator that produced a series. It is injected from
	// the generator's ring config and falls back to the hostname when empty.
