...
// EncodeKey returns a stable hex-encoded "k1-k2" string identifier for a pair
// of byte slices (typically traceID + spanID). It allocates a fresh buffer; for
// callers reusing a buffer use encodeKeyToString.
