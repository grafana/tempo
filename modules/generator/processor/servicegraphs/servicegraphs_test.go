...
func TestServiceGraphs(t *testing.T) {
	...
	expectedMetrics := []test_util.Metric{
		...
		{`{client="app", server="db", __name__="traces_service_graph_request_client_seconds_bucket", le="+Inf"}`, 3},
		...
		{`{client="app", server="db", __name__="traces_service_graph_request_server_seconds_bucket", le="+Inf"}`, 3},
		...
		{`{client="lb", server="app", __name__="traces_service_graph_request_client_seconds_bucket", le="+Inf"}`, 3},
		...
		{`{client="lb", server="app", __name__="traces_service_graph_request_server_seconds_bucket", le="+Inf"}`, 3},
