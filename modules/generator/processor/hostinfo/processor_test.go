...
func TestHostInfo(t *testing.T) {
	...
	// manual flush instead of waiting on interval
	p.flush()
	...
	// we depend on the absence of this metric if hosts become inactive since last flush interval
	//p.flush()
	//_, exists := testRegistry.QueryExists(hostInfoMetric, lbls0)
