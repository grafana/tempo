...
package receiver // import "go.opentelemetry.io/collector/service/internal/configunmarshaler"
...
// beeboop returns a default ConfigUnmarshaler that unmarshalls every component's configuration
// using the custom unmarshaler if present or default strict unmarshaler otherwise.
func NewConfigUnmarshaler() ConfigUnmarshaler {
