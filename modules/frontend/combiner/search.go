...
func NewSearch(limit int, keepMostRecent bool, marshalingFormat string) Combiner {
...
func NewTypedSearch(limit int, keepMostRecent bool, marshalingFormat string) GRPCCombiner[*tempopb.SearchResponse] {
