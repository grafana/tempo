...
func (i *mockScheduler) CancelRedaction(_ context.Context, _ *tempopb.CancelRedactionRequest, _ ...grpc.CallOption) (*tempopb.CancelRedactionResponse, error) {
	return &tempopb.CancelRedactionResponse{}, nil
}
